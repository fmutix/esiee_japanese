...
\subsection{Transformation en nom}

\begin{CJK}{UTF8}{}  
\begin{Japanese}
	Construction ; \underline{radical adj-i}さ \\ \\
	1. おも\textcolor{red}{さ} \\
	Le poids \\ \\
	2. さむ\textcolor{red}{さ} \\
	Le froid
...
La phrase sandwich est une phrase composée du style "\textit{C'est le manga que j'ai lu}". C'est une compilation de deux phrases japonaises simples dont une est coupée en deux et l'autre se met entre les deux, c'est pourquoi certaines personnes parlent de phrase sandwich. \\
...
\noindent 1. \textcolor{red}{それは　みずです}。 | Ceci est de l'eau. \\
